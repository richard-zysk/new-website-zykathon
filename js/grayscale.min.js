...
var navbarCollapse = function () {
    100 < $("#mainNav").offset().top || mobile
      ? $("#mainNav").hasClass("navbar-shrink") ||
  ...
  windowResize(),
    ...
    n('a.js-scroll-trigger[href*="#"]:not([href="#"])').click(function () {
      if (
        ...
        var a = n(this.hash);
        if ((a = a.length ? a : n("[name=" + this.hash.slice(1) + "]")).length)
          return (
            n("html, body").animate(
    ...
    n("body").scrollspy({ target: "#mainNav", offset: 100 }),
    navbarCollapse(),
    n(window).scroll(navbarCollapse);
})(jQuery);
